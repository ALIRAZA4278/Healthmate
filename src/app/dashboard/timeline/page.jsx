    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Medical Timeline</h1>
          <p className="text-gray-600">Your complete health history in chronological order</p>
        </div>

        {timeline.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-12 text-center">
                      ...
                      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <div className="min-w-0">
                            <h3 className="font-bold text-gray-900 break-words">{item.fileName}</h3>
